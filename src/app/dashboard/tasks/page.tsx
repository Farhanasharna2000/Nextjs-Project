                        ...
                        tasks.map(task => (
                            <div key={task.id}
                                ...
                                <section className='flex space-x-4'>
                                    ...
                                    {/* buttons  */}
                                    <button
                                        className='px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 transition-colors rounded-lg'>
                                        Edit
                                    </button>
                                    {
                                        task.status !== 'Completed' && (
                                            <button
                                                className='px-4 py-2 text-white bg-green-600 hover:bg-green-700 transition-colors rounded-lg'>
                                                Mark as Complete
                                            </button>
                                        )
                                    }
                                    <button
                                        className='px-4 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 transition-colors rounded-lg'>
                                        Delete
                                    </button>
                                </section>
                            </div>
